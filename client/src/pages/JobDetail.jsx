...
export default function JobDetail() {
  ...
  async function submitApplication(event) {
    ...
    try {
      ...
      setMessage("Application submitted. You can upload the CV on the candidate page.");
      setShowApply(false);
      setApplyForm((current) => ({ ...current, phone: "", source: "", coverNote: "" }));
      await load();
      navigate("/candidates/" + result.application.id);
    } catch (err) {
      setError(err.message);
    } finally {
      setBusy(false);
    ...
    <div className="page">
      <div className="page-head">
        ...
        <div className="btn-row">
          ...
          >
            {showApply ? "Cancel" : "Apply / add candidate"}
          </button>
        </div>
      </div>
      ...
      {showApply && (
        <div className="card mb-2">
          <div className="card-title">
            ...
            <span className="muted small">The candidate starts at “{job.stages?.[0]}”.</span>
          </div>
          ...
          <form onSubmit={submitApplication}>
            <div className="grid grid-2">
              ...
              <Field label="Email" htmlFor="applicantEmail">
                <input
                  id="applicantEmail"
                  className="input"
                  type="email"
        ...
        <div>
          ...
          <div className="card">
            <div className="card-title">
              ...
              <Link className="small" to={"/candidates?job=" + job.id}>
                Open in candidates
              </Link>
            </div>
                  ...
                  <tbody>
                    {applicants.map((applicant) => (
                      <tr key={applicant.id}>
                        ...
                        <td>
                          {applicant.cv ? (
                            <a href={api.cvDownloadUrl(applicant.id)}>Download</a>
                          ) : (
                        ...
                        <td className="cell-right">
                          <Link className="btn btn-secondary btn-sm" to={"/candidates/" + applicant.id}>
                            View
                          </Link>
                        </td>
                      </tr>
        ...
        <div className="card">
          ...
          <div className="detail-grid mt-2">
            ...
            <div>
              ...
              <div className="detail-value">{job.closingDate ? formatDate(job.closingDate) : "Open ended"}</div>
            </div>
            <div>
